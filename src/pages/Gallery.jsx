        ...
        <div className="min-h-screen flex flex-col justify-between overflow-y-hidden bg-black text-white">
            ...
            <section className="w-full flex flex-wrap justify-center gap-3 mt-8 lg:mt-28">
                <div className="w-11/12 h-[30vh] lg:w-[30%] overflow-hidden">
                    <Link to="#" className=""><div className="bg-[url(' + require('./images/carousel/lg1.jpg') + ')] bg-cover saturate-0 bg-no-repeat h-full bg-center flex justify-center items-center hover:saturate-100 hover:scale-150 transition-all duration-700"><p className="text-4xl font-extrabold opacity-80">Vest</p></div></Link>
                </div>
